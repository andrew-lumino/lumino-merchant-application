  ...
  const handleAgentAction = async (action: "send" | "copy") => {
    ...
    try {
      ...
      const response = await fetch("/api/save-prefill-data", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ applicationId: appId, formData, principals, merchantEmail, action }),
      })
    ...
    <Card>
      <CardHeader className="text-center">
        <div className="mx-auto mb-4">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Asset%201-RAzSkc3nOwQkrKaww9K8u5pyOf1KZg.png"
            alt="LUMINO"
